...
We did not copy every suggestion directly. We used the mentoring sessions to decide what to **adopt**, what to **pivot**, and what to **push further** so the final product still felt like SPCE.

| **Date** | **Mentor** | **Feedback Received** | **How We Responded** |
| --- | --- | --- | --- |
| **7 Sep 2026 · 11:25 PM** | **Sim Hong Bing** | Validated the **Personal Capacity AI** direction and recommended keeping the hackathon implementation practical. Suggested **React Native**, **Deepgram** for voice input, hosted AI instead of a heavy local model, and a managed backend such as **Convex or Supabase**. Also highlighted iOS deployment friction and suggested Android or PWA as easier fallbacks. | **Adopted:** React Native, Deepgram, managed cloud services and a lightweight architecture. **Pivoted:** instead of making a hosted LLM the decision-maker, we separated AI understanding from SPCE's structured **Capacity, FIT, WHY, FIX and Human Approval** logic. **Improved further:** we kept the product iOS-first because Back Tap is central to UNLOAD, while treating Android/PWA as fallback deployment options rather than changing the product direction. |
| **11 Sep 2026 · 11:25 PM** | **Sim Hong Bing** | Said the prototype had useful features but could still be visually and experientially grouped with many other productivity apps. Challenged us to answer **“Why now?”** and make the project more memorable. Suggested possibilities such as realtime AI, generated visuals, gamification, bots, avatars and more unconventional interaction. | **Used the principle, not every feature literally.** We did not turn SPCE into a generic chatbot, avatar or gamified calendar. **Pivoted:** we focused the differentiation around SPCE's own strongest ideas: **Personal Pattern Insights** and capacity-aware reasoning. **Improved beyond the suggestion:** we introduced **Comfort Circle, Give Comfort + Kindness Streak, and the AR Comfort Wall**, where supportive messages appear as spatial sticky notes on a real wall or desk. We also strengthened the visual identity and made AI reasoning more visible through **WHY, Insights and Human Approval**. |

> **Mentor impact:** The first session helped us make SPCE **more buildable**. The second pushed us to make it **more memorable**, while still keeping the product centred on personal capacity rather than adding novelty for its own sake.
